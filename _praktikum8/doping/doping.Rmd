...
> Praktikumis arutasime parameetrite hindamist ja kasutasime paketi `MASS` funktsiooni `fitdistr`.
...
[Bootstrap](http://en.wikipedia.org/wiki/Bootstrapping_%28statistics%29) on üks viis leida valimihinnangule (näiteks meid huvitavale kvantiilile) usaldusintervall. Kui bootstrap on sinu jaoks uus, on abiks järgnev video. 
