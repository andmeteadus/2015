...
1. Tsentreeri andmestik (ehk lahuta igast tunnusest tema keskmine). Tähistame tsentreeritud andmemaartiksit $X$ (vaatlused ridades, tunnused veergudes). 

2. Arvuta kovariatsioonimaatriks $X^T X$. (Näpunäide: maatriksite korrutamiseks on R-is operaator `%*%`.)

3. Leia kovariatsioonimaatriksi omaväärtused ja omavektorid. (Näpunäide: Abiks on funktsioon `eigen`)

4. Esimese omavektori elemendid on PC1 kordajad, teise omavektori elemendid PC2 kordajad jne. Kasuta nüüd neid kordajaid maatriksi $X$ elementidele, et leida PC1 ja PC2 väärtus. 
