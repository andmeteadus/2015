...
Kõige lihtsam on kasutada raporti kirjutamisel märgenduskeelt Markdown. Joonisel on kõrvuti näidatud nii Markdown keeles kirjutatud koodi näide kui ka tulemus html-ina. 
...
Näiteks kui salvestasid lähtekoodi faili `praks1.Rmd`, siis on väljundiks saadud html samas kaustas nimega `praks1.html`. Juhul, kui soovid html-i asemel saada pdf-i, peab `.Rmd` faili algus olema selline
