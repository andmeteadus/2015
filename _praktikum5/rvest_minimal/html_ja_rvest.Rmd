...
Minimaalne näide, kuidas eelneval pildil näidatud [HTML lähtekoodist](minimal_html.html) eraldada pealkirja ja lõiku.
...
XML on märgistuskeel, mille eesmärgiks on struktureeritud info jagamine. XML koosneb kasutaja defineeritud siltidest (tags), mis märgitakse sümbolite < > vahele ning mille abil kirjeldatakse andmete struktuuri. Järgnevalt on toodud minimalistlik näide, kuidas [XML failist](minimal_xml.xml) eraldada infot.
