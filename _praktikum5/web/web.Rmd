...
Eralda [html koodis](html1.html) sinisena olev tekst muutujasse `tekst`. Kasuta paketti *rvest*. 
...
* Loe lühiülevaadet, [millest koosnevad veebilehed](http://andmeteadus.github.io/praktikum5_html_ja_rvest.html).

* Uuri paketi [*rvest* minimalistlikku näidet](http://andmeteadus.github.io/praktikum5_html_ja_rvest.html#html).
...
Eralda [html koodis](html2.html) punaselt olev tekst muutujasse `tekst`. Kasuta paketti *rvest*. 
